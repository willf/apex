...
;;;
;;; apex/system/utility/matrix.lisp
;;;
;;; Copyright:      See apex/LICENSE
;;; Version:        $Id: matrix.lisp,v 1.3 2006/01/15 03:43:02 dalal Exp $


;;; A matrix facility added by Walter Talbot as part of his summer
;;; project (2004) on Learning.
...
(declaim (inline matrixp num-rows num-cols))
      ...
      (dotimes (j size)
        (setf (aref result i j)
              (if (= i j)
                  (/ (aref result i j))
		(if (= temp 0)
		    (return-from invert-matrix :singular)
