...
;;;
;;; apex/examples/walters-world/gaze.lisp
;;;
;;; Copyright:      See apex/LICENSE
;;; Version:        $Id: gaze.lisp,v 1.2 2006/01/15 03:42:56 dalal Exp $
...
(defmethod fixated (gaze-resource visob &key cause)
  ...
  (setx (locus gaze-resource) visob)
  (setx (fixation gaze-resource) (pos visob))
...
(defun set-interest (gaze-resource feature &key cause)
  (declare (ignore cause))
  (setx (interest gaze-resource) feature))
