...
;;;
;;; apex/examples/pit-stop-estimate.lisp
;;;
;;; Copyright:      See apex/LICENSE
;;; Version:        $Id: pit-stop-estimate.lisp,v 1.10 2006/01/15 03:42:52 dalal Exp $

(in-package :user)

(defapplication "Pit Stop with estimation"
    :init (initialize-sim))
...
(procedure 
  ...
  (step s1 (use resource (car) for 5 +/- 1 min)
	(waitfor (:measurement o1 (message-read vision = |rest stop|)
			       :estimation (:persist :with-timeout P30M))) )
